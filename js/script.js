...
function personagens() {
  ...
  let sub_title = document.querySelectorAll(".sub_title_info_caracteristicas ul li");
    ...
    element.addEventListener('click', () => {
      ...
      switch (key) {
        case 0:
          ...
          sub_title[0].innerHTML = `Mais balanceado em status.<br> `;
          sub_title[1].innerHTML = `Apesar de não tem nenhuma habilidade especial, sua vantagem é poder se transferir para classes mais especializadas.`;
        ...
        case 1:
          ...
          sub_title[0].innerHTML = `São velozes em ataque, movimento e lançamento de magias. São precisos em seus ataques, além de ter alto poder de evasão. Seu ponto fraco é sua força de ataque em relação as outras raças.<br>`;
          sub_title[1].innerHTML = `Os elfos podem ficar submersos por mais tempo e saltar para locais mais altos.`;
        ...
        case 2:
          ...
          sub_title[0].innerHTML = `Eles possuem alto de poder de Ataque e Magia (Força e Inteligência).<br>`;
          sub_title[1].innerHTML = `Os elfos podem ficar submersos por mais tempo e saltar para locais mais altos.`;

          video.src = "races_video_loop/dark_elf.mp4";
          info_tipo.innerHTML = `É um tipo de lutador básico, que possui grande força e utiliza armaduras leves (light) e pesadas (heavy). No estilo de jogo eles são habilidosos em combate de curto alcance, 
          principalmente usando espadas, mas também podem se especializar em combate de longo alcance mais tarde em suas Jobs.<br><br>

          O Dark Elfo Lutador em sua primeira mudança de classe, pode ser:<br><br>
          <ul>
            <li>
            <b>Assassin:</b> Os que querem seguir caminho para Abyss Walker (Caçadores de recompensas que usam espadas curtas) ou o caminho do Phantom Ranger (Arqueiros).<br>
            </li>
            <li> 
            <b>Palus Knight:</b> Os que querem seguir o caminho para Shillen Knight (guerreiros especializados na defesa) ou Blade Dancer (dançarinos que dão suporte através da dança).
            </li>
          </ul>
          `;
        ...
        case 3:
          ...
          sub_title[0].innerHTML = `Possuem grande força e são robustos em vida e mana, possuem alta capacidade de regeneração de vida, no entanto são classes lentas em movimento, lançamento de magias e ataques.<br>`;
          sub_title[1].innerHTML = `Forte resistência a efeitos negativos (debuffs), como venenos, paralisias.`;
          info_tipo.innerHTML = `
          É um tipo de lutador, que possui grande força e utiliza armaduras leves (light). No estilo de jogo eles são habilidosos em combate corpo a corpo, principalmente usando espadas de duas mãos e grandes garras.<br><br>
        ...
        case 4:
          ...
          sub_title[0].innerHTML = ` São os únicos capazes de criar itens e possuem grande força. <br>`;
          sub_title[1].innerHTML = `Possui o maior inventário em relação as outras raças e sua penalidade de peso é menor.`;
...
function close_modal() {
  ...
  let open_modal = document.querySelector(".container_modal");
  let btn_modal = document.querySelector(".sub_title_container_baixar p b")
  let close_modal = document.querySelector(".close_modal");
